...
describe Emailer do
  describe 'instructions' do
    ...
    let(:user) { mock_model(:email => 'lucas@email.com', :password => '12341234', :first_name =>'Tung-Keng Lee', :last_name => 'Lee', :street => '5700 Centre Ave.', :country => 'USA', :zip =>'15206', :phone => '4126801073') }
    let(:mail) { Emailer.deliver_contact(1) }
    ...
    it 'renders the receiver email' do
      mail.to.should == ['risingfalcons19@gmail.com']
    end
